...
const generateCertificate = (data) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            // 🎨 1. FULL SVG LAYERING (Top Right, Bottom Right, Bottom Left)
            doc.save();
            // Top Right
            ...
            // 🟢 3. BODY TEXT WITH BOLDING & EXTRA SPACING
            currentY += 90;
            ...
            // Second Line with Extra Gap
            currentY += 35; // Increased spacing to prevent overlap

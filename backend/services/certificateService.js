...
const generateCertificate = (data) => {
    return new Promise(async (resolve, reject) => {
        try {
            // 🟢 1. CORRECTED: Define filePath at the very start
            ...
            // 🎨 2. FULL SVG LAYERING (From your model)
            doc.save();
            // Top Right
            ...
            // 📝 3. TEXT CONTENT WITH COORDINATE TRACKING
            let currentY = 135;
            ...
            // 🟢 4. FIXED BODY TEXT (Bold requested fields & moved lines)
            currentY += 95;
            ...
            // Second Line (Forced gap to prevent overlap)
            currentY += 40; 
